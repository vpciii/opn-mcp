...
PR #14 synchronized the templates in `docs/scheduled-tasks/` with the active skill instructions in `scheduled-tasks/` (commit [bb54f6f](https://github.com/vpciii/opn-mcp/blob/main/docs/reviews/pr13_adversarial_review.md)).
* Both [docs/scheduled-tasks/daily-summary.md](https://github.com/vpciii/opn-mcp/blob/main/docs/scheduled-tasks/daily-summary.md) and [docs/scheduled-tasks/security-check.md](https://github.com/vpciii/opn-mcp/blob/main/docs/scheduled-tasks/security-check.md) now contain the complete set of instructions, including the daily firmware refresh check (Step 0) and the synthetic status checks (WireGuard, gateway status, swap pressure).
* This eliminates the risk of operators copying stale/broken prompts when following the monitoring guide in [docs/MONITORING.md](https://github.com/vpciii/opn-mcp/blob/main/docs/MONITORING.md), resolving the artifact honesty defect.
...
PR #14 added two unit tests in [tests/test_updates_available.py](https://github.com/vpciii/opn-mcp/blob/main/tests/test_updates_available.py) (commit [acba5c9](https://github.com/vpciii/opn-mcp/blob/main/docs/reviews/pr13_adversarial_review.md)):
...
* **Location:** [docs/scheduled-tasks/daily-summary.md:L23](https://github.com/vpciii/opn-mcp/blob/main/docs/scheduled-tasks/daily-summary.md#L23) and [scheduled-tasks/opnsense-daily-summary/SKILL.md:L23](https://github.com/vpciii/opn-mcp/blob/main/scheduled-tasks/opnsense-daily-summary/SKILL.md#L23)
...
* **Location:** [server.py:L799](https://github.com/vpciii/opn-mcp/blob/main/server.py#L799)
